...
console.log("test");
    ...
    driver.findElement(By.xpath("//li[@movie_idx='80585']")).click()
    .then(function(res){
      driver.sleep(2000)
      driver.findElement(By.xpath("//li[@id='sbmt_imax']")).click()

      console.log("success : "+res)
      // driver.findElement(By.xpath("//li[@play_start_tm='1500']")).getText()
      // driver.findElement(By.xpath("//li[@play_start_tm='1500']")).getText();
    })
    .then(function(res){
      driver.sleep(2000)
